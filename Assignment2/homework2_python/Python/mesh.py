...
class HalfedgeMesh:
    ...
    def __init__(self, filename=None, vertices=[], halfedges=[], facets=[]):
        """Make an empty halfedge mesh.
           ...
           filename   - a string that
           holds the directory location and name of
               the mesh
    ...
    def read_file(self, filename):
        ...
        try:
            with open(filename, 'r') as file:
                ...
                first_line = file.readline().strip().upper() # strip off the first line in off file
    ...
    def parse_off(self, file_object):
        ...
        print("vertices_faces_edges_counts:", vertices_faces_edges_counts)
